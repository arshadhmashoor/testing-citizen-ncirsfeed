  ...
  return (
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        {/*titles */}
        <div className='mb'>
          <h1 className='text-3xl font-bold text-slate-900 mb-2'>reply Messages</h1>
          <p className='text-slate-600'>Talk about your issues</p>
        </div>

        {/*connected Authories and other users */}
