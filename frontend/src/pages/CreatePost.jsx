  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        {/*title */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-slate-900 mb-2'>Create Issue Post</h1>
          <p className='text-slate-600'>share your issues</p>
        </div>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          {/*post text area */}
          <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' placeholder="type the issue" onChange={(e)=>setContent(e.target.value)} value={content}/>
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <button disabled={loading} onClick={()=>toast.promise(
              ...
              {
                loading: 'uploading ...',
                success: <p>Issue Posted</p>,
                error: <P>Issue not posted</P>
              }
