...
const Profile = () => {
  ...
  //execute this func whenever the componenetis called
  useEffect(()=>{
    fetchUser()
  },[])
      ...
      <div className='max-w-3xl mx-auto'>
        ...
        <div className='bg-white rounded-2xl shadow overflow-hidden'>
          ...
          <div className='h-40 md:h-56 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200'>
            {user.cover_photo && <img src={user.cover_photo} alt='w-full h-full object-cover' className=''/>}
          </div>
          {/* User Info */}
          <UserProfileInfo user={user} posts={posts} profileId={profileId} setShowEdit={setShowEdit}/>

        </div>
        {/*tabs of issues and media and votes */}
        <div className='mt-6'>
          <div className='bg-white rounded-xl shadow p-1 flex max-w-md mx-auto'>
            <div className='text-center'>
              <h2 className='text-slate-600'>My Posted Issues</h2>              
            </div>
            {/* {["My Issues"].map((tab)=>(
